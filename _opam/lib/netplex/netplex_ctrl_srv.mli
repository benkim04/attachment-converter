...
module Sharedvar : sig
  module V2 : sig
    ...
    val bind :
            ?program_number:Netnumber.uint4 ->
            ?version_number:Netnumber.uint4 ->
            proc_ping : (t_Sharedvar'V2'ping'arg -> t_Sharedvar'V2'ping'res) ->
            proc_create_var : (t_Sharedvar'V2'create_var'arg ->
                               t_Sharedvar'V2'create_var'res) ->
            proc_set_value : (t_Sharedvar'V2'set_value'arg ->
                              t_Sharedvar'V2'set_value'res) ->
            proc_get_value : (t_Sharedvar'V2'get_value'arg ->
                              t_Sharedvar'V2'get_value'res) ->
            proc_delete_var : (t_Sharedvar'V2'delete_var'arg ->
                               t_Sharedvar'V2'delete_var'res) ->
            proc_wait_for_value : (t_Sharedvar'V2'wait_for_value'arg ->
                                   t_Sharedvar'V2'wait_for_value'res) ->
            proc_dump : (t_Sharedvar'V2'dump'arg -> t_Sharedvar'V2'dump'res) ->
            proc_shm_slot : (t_Sharedvar'V2'shm_slot'arg ->
